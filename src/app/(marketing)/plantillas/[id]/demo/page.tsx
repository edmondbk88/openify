...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `Demo en Vivo - "${template.name}" con 30 Testimonios | Opinafy`,
    description: `Ve como luce la plantilla "${template.name}" con 30 testimonios reales. Demo interactiva del widget de testimonios de Opinafy.`,
    robots: {
      index: true,
      follow: true,
    },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center gap-3">
            <span className="hidden text-sm text-gray-500 sm:inline">
              Demo: <strong className="text-gray-900">{template.name}</strong> — 30 testimonios
            </span>
            <Link
              href="/registro"
        ...
        <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-lg">
          ...
          <div className="border-b border-gray-200 bg-gray-50 px-5 py-3">
            <div className="flex items-center gap-2">
              ...
              <span className="ml-3 text-xs text-gray-400">tu-web.com — Demo con 30 testimonios</span>
            </div>
          </div>
      ...
      <div className="border-t border-gray-200 bg-white px-4 py-12 text-center sm:px-6 lg:px-8">
        <h2 className="text-2xl font-bold text-gray-900">Te gusta como se ve?</h2>
        <p className="mt-3 text-gray-600">
          Registrate gratis y usa esta plantilla con tus propios testimonios en minutos.
        </p>
        <Link
          href="/registro"
