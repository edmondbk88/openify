      ...
      <section className="mx-auto max-w-4xl space-y-8 px-4 pb-16 sm:px-6 lg:px-8">
        ...
        <StepCard number={3} title="Agrega el código a Wix">
          ...
          <div className="space-y-6">
            <div>
              <h4 className="mb-2 font-semibold text-gray-900">Opción A: Elemento HTML embebido (recomendado)</h4>
              <ol className="ml-4 list-decimal space-y-2">
                ...
                <li>Arrastra el elemento a la posición deseada en tu página.</li>
            ...
            <div>
              <h4 className="mb-2 font-semibold text-gray-900">Opción B: Wix App Market</h4>
            ...
            <div>
              <h4 className="mb-2 font-semibold text-gray-900">Opción C: Wix Velo (usuarios avanzados)</h4>
              ...
              <ol className="ml-4 list-decimal space-y-2">
                ...
                <li>En el código del componente, carga el script de Opinafy dinámicamente.</li>
        ...
        <StepCard number={4} title="Verifica que funciona">
          <ol className="ml-4 list-decimal space-y-2">
            ...
            <li>El widget debería cargar automáticamente mostrando tus testimonios aprobados.</li>
        ...
        <div className="rounded-xl border border-blue-200 bg-blue-50 p-6">
          ...
          <ul className="ml-4 list-disc space-y-2 text-sm text-blue-800">
            ...
            <li>Funciona tanto en sitios Wix clásicos como en Wix Studio.</li>
          </ul>
        </div>
      </section>
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                a: 'Si. El widget funciona tanto en el editor clásico de Wix como en Wix Studio. Solo necesitas agregar un elemento HTML embebido.',
              },
              {
