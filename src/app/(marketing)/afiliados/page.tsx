...
export const metadata: Metadata = {
  ...
  description:
    'Gana un 30% de comision recurrente recomendando Opinafy, la plataforma #1 de testimonios en espanol. Cookie de 90 dias, pagos mensuales y materiales de marketing incluidos.',
  keywords: [
...
const steps = [
  {
    ...
    description: 'Crea tu cuenta de afiliado en menos de 2 minutos. Recibiras tu enlace unico de referido al instante.',
    icon: (
...
const audiences = [
  ...
  },
  {
    ...
    description: 'Anade una fuente de ingresos pasivos recomendando una herramienta que ya usas o conoces.',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
      ...
      <section className="bg-gradient-to-b from-indigo-50 to-white px-4 pb-16 pt-24 sm:pb-24 sm:pt-32">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mt-6 text-lg text-gray-600 sm:text-xl">
            Gana comisiones recomendando la plataforma #1 de testimonios en espanol.
      ...
      <section className="bg-indigo-600 px-4 py-16 sm:py-24">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-4 text-lg text-indigo-100">
            Unete al programa de afiliados y genera ingresos recurrentes recomendando la plataforma de testimonios mas completa en espanol.
          </p>
          <Link
            href="/registro"
