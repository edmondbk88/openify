...
export async function generateStaticParams() {
  return industriesEn.map((industry) => ({
    slug: industry.slug,
  }))
}
...
export async function generateMetadata({ params }: IndustryPageProps): Promise<Metadata> {
  ...
  return {
    ...
    openGraph: {
      ...
      type: 'website',
      locale: 'en_US',
      url: `https://opinafy.com/en/testimonials-for/${industry.slug}`,
      siteName: 'Opinafy',
      images: [
        {
          url: '/og.png',
    ...
    alternates: {
      canonical: `https://opinafy.com/en/testimonials-for/${industry.slug}`,
    },
  }
}
...
export default async function IndustryPageEn({ params }: IndustryPageProps) {
  const { slug } = await params
  const industry = industriesEn.find((i) => i.slug === slug)
  ...
  const breadcrumbJsonLd = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: industry.name, item: `https://opinafy.com/en/testimonials-for/${industry.slug}` },
    ],
  }
  ...
  return (
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
          <ol className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <li className="flex items-center gap-2">
              ...
              <Link href="/en/testimonials-for" className="hover:text-indigo-600">
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-center text-3xl font-bold text-gray-900 sm:text-4xl">
            Why are testimonials key for {industry.name.toLowerCase()}?
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-center text-lg text-gray-600">
            Discover the specific benefits of using testimonials in your industry.
          </p>
      ...
      <section className="py-16 sm:py-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-center text-3xl font-bold text-gray-900 sm:text-4xl">
            What {industry.name.toLowerCase()} professionals say
          </h2>
          <p className="mx-auto mt-4 max-w-2xl text-center text-lg text-gray-600">
            Professionals in your industry already trust Opinafy to manage their testimonials.
          </p>
          <div className="mt-12 grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <section className="bg-gray-50 py-16 sm:py-24">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-center text-lg text-gray-600">
            Answers to common questions about testimonials for {industry.name.toLowerCase()}.
          </p>
      ...
      <section className="bg-indigo-600 py-16">
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-indigo-100">
            Create your free account in less than 2 minutes and start collecting
            customer testimonials with Opinafy.
          </p>
