...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    'verified testimonial ranking',
    'top rated companies',
    'customer testimonials ranking',
    'best business reviews',
    'social proof ranking',
  ],
  alternates: {
    canonical: 'https://opinafy.com/en/ranking',
    languages: {
  ...
  openGraph: {
    ...
    description:
      'Discover the top-rated businesses by their customers on Opinafy.',
    url: 'https://opinafy.com/en/ranking',
    type: 'website',
    siteName: 'Opinafy',
    locale: 'en_US',
...
export default async function RankingPageEn() {
      ...
      <main className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="text-center">
          ...
          <h1 className="mt-4 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
            Top Rated Businesses on Opinafy
          </h1>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-600">
            The highest-rated businesses by their customers, with verified testimonials and trust certifications.
          </p>
        </div>
        ...
        <div className="mt-12">
          {ranking.length > 0 ? (
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-500">Business</th>
                    <th className="px-4 py-3 text-center text-xs font-semibold uppercase tracking-wider text-gray-500">Rating</th>
                    <th className="px-4 py-3 text-center text-xs font-semibold uppercase tracking-wider text-gray-500">Testimonials</th>
                    <th className="px-4 py-3 text-center text-xs font-semibold uppercase tracking-wider text-gray-500">Certification</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-gray-100">
                  {ranking.map((item, index) => {
                    const tier = (item.certification_tier as CertificationTier) || getCertificationTier(item.testimonial_count)
                    const tierLabel = getTierLabel(tier, 'en')
            ...
            <div className="rounded-xl border border-dashed border-gray-300 bg-gray-50 px-8 py-16 text-center">
              ...
              <h3 className="mt-4 text-lg font-semibold text-gray-700">Businesses coming soon</h3>
              <p className="mt-2 text-sm text-gray-500">
                Businesses need at least 5 approved testimonials to appear here.
              </p>
              <Link
                href="/en/pricing"
        ...
        <div className="mt-16 rounded-2xl bg-gradient-to-r from-indigo-600 to-purple-600 p-8 text-center text-white sm:p-12">
          <h2 className="text-2xl font-bold sm:text-3xl">Want to appear in the ranking?</h2>
          <p className="mx-auto mt-3 max-w-lg text-indigo-100">
            Start collecting verified testimonials from your customers and position your business among the top rated.
          </p>
