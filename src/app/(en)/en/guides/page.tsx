...
const guides = [
  ...
  },
  {
    name: 'Webflow',
    slug: 'webflow',
    description: 'Integrate Opinafy into your Webflow site using project custom code, page-specific code, or Embed elements.',
    color: 'bg-blue-100 text-blue-700',
    iconColor: 'text-blue-600',
    icon: (
  ...
  },
  {
    ...
    description: 'Install Opinafy with Google Tag Manager. Ideal if you already use GTM to manage your site scripts.',
