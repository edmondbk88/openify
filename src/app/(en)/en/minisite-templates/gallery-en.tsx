...
const TEMPLATE_DESC_TRANSLATIONS: Record<string, string> = {
  'Azul sanitario suave y limpio. Ideal para médicos y clinicas.': 'Soft, clean medical blue. Ideal for doctors and clinics.',
  ...
  'Verde orgánico y fresco. Para nutricionistas y dietistas.': 'Fresh organic green. For nutritionists and dietitians.',
  'Azul dinámico con energía. Ideal para fisioterapeutas.': 'Dynamic, energetic blue. Ideal for physiotherapists.',
  ...
  'Rosa vibrante y moderno. Ideal para diseñadores gráficos.': 'Vibrant, modern pink. Ideal for graphic designers.',
  'Lineas limpias y minimalismo. Para arquitectos y estudios.': 'Clean lines and minimalism. For architects and studios.',
  'Oscuro cinematográfico. Perfecto para videografos y productoras.': 'Cinematic dark theme. Perfect for videographers and producers.',
  ...
  'Ambar clásico academico. Para academias y centros de formación.': 'Classic academic amber. For academies and training centers.',
  ...
  'Negro potente con rojo energía. Para entrenadores personales.': 'Powerful black with energetic red. For personal trainers.',
