...
import { helpGuidesEn, helpCategoriesEn } from '@/lib/help-data-en'
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://opinafy.com/en/help',
    languages: {
      es: 'https://opinafy.com/ayuda',
    },
  },
  openGraph: {
    type: 'website',
...
export default function HelpIndexPage() {
  ...
  const guidesByCategory = helpCategoriesEn.map((cat) => ({
    ...cat,
    guides: helpGuidesEn.filter((g) => g.category === cat.id),
  }))
    ...
    <div className="bg-gradient-to-b from-indigo-50/50 to-white">
      ...
      <section className="mx-auto max-w-4xl px-4 pb-12 pt-24 sm:px-6 lg:px-8">
        <div className="text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-600">
            Find detailed guides about all of Opinafy features.
            From getting started to the most advanced tools.
          </p>
        </div>
      </section>
      ...
      <section className="border-t border-gray-200 bg-gray-50">
        <div className="mx-auto max-w-4xl px-4 py-16 text-center sm:px-6 lg:px-8">
          <h2 className="text-2xl font-bold text-gray-900">Cannot find what you are looking for?</h2>
          <p className="mx-auto mt-3 max-w-xl text-gray-600">
            If you have a question that is not covered in our guides, do not hesitate to contact us.
            We are here to help.
          </p>
