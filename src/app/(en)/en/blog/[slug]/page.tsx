...
export async function generateStaticParams() {
  return blogArticlesEn.map((article) => ({
    slug: article.slug,
  }))
}
...
export async function generateMetadata({ params }: BlogPostPageProps): Promise<Metadata> {
  ...
  const article = blogArticlesEn.find((a) => a.slug === slug)
  ...
  return {
    ...
    alternates: {
      canonical: `https://opinafy.com/en/blog/${article.slug}`,
    },
  }
}
...
export default async function BlogPostPageEn({ params }: BlogPostPageProps) {
  ...
  const relatedArticles = blogArticlesEn
  ...
  const breadcrumbJsonLd = breadcrumbSchema([
    ...
    { name: article.title, url: `https://opinafy.com/en/blog/${article.slug}` },
  ])
    ...
    <>
      ...
      <article className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <nav className="mb-8 text-sm text-gray-500">
          ...
          <Link href="/en/blog" className="hover:text-indigo-600">
            Blog
          </Link>
          <span className="mx-2">/</span>
        ...
        <header className="mb-12">
          ...
          <div className="mt-6 flex items-center gap-4">
            ...
            <div>
              <p className="text-sm font-medium text-gray-900">Opinafy Team</p>
        ...
        <div className="mt-16 rounded-2xl bg-gradient-to-br from-indigo-600 to-indigo-700 p-8 text-center text-white sm:p-12">
          ...
          <p className="mx-auto mt-4 max-w-xl text-indigo-100">
            Opinafy helps you collect, manage, and display customer testimonials professionally.
