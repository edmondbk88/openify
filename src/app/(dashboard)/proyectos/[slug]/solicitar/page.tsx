...
export default function SolicitarPage() {
  ...
  return (
    <div className="mx-auto max-w-2xl">
      ...
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-2xl font-bold text-gray-900">Solicitar testimonios</h1>
        <p className="mt-1 text-sm text-gray-500">
          Envía solicitudes de testimonios a tus clientes por WhatsApp, email o comparte el enlace.
        </p>
      </div>
      ...
      <div className="rounded-xl border border-gray-200 bg-white p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-sm font-semibold text-gray-900">Enviar por WhatsApp</h2>
        </div>
      ...
      <div className="mt-6 rounded-xl border border-gray-200 bg-white p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-sm font-semibold text-gray-900">Enviar por email</h2>
        </div>
      ...
      <div className="mt-6 rounded-xl border border-gray-200 bg-white p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-sm font-semibold text-gray-900">Codigo QR</h2>
        </div>
      ...
      <div className="mt-6 rounded-xl border border-gray-200 bg-white p-6">
        <div className="flex items-center gap-2 mb-4">
          ...
          <h2 className="text-sm font-semibold text-gray-900">Copiar enlace</h2>
        </div>
