...
export async function GET(
  ...
  try {
    ...
    let query = supabase
      .from('testimonials')
      .select('id, author_name, author_company, author_role, author_avatar_url, content, rating, video_url, photo_url, is_company_verified, source, source_platform, source_url, owner_reply, created_at')
      .eq('project_id', projectId)
      .eq('status', 'approved')
