...
export const PLATFORMS: Record<string, Platform> = {
  google: {
    ...
    description: 'Copia y pega tus resenas de Google Maps',
  },
  tripadvisor: {
    name: 'TripAdvisor',
    color: '#00AF87',
  ...
  trustpilot: {
    ...
    description: 'Trae tus resenas de Trustpilot',
  },
  facebook: {
    name: 'Facebook',
    color: '#1877F2',
  ...
  g2: {
    ...
    description: 'Importa resenas de G2',
  },
  form: {
    name: 'Formulario',
    color: '#6366f1',
