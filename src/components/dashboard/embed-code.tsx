  ...
  return (
    <div className="rounded-xl border border-gray-200 bg-white">
      <div className="flex items-center justify-between border-b border-gray-200 px-4 py-3">
        <h3 className="text-sm font-semibold text-gray-900">Código de integración</h3>
        <button
          onClick={handleCopy}
          className={cn(
      ...
      <div className="px-4 py-3">
        <p className="text-xs text-gray-500">
          Pega este código en tu sitio web donde quieras mostrar los testimonios. El widget se cargará automáticamente.
        </p>
      </div>
    </div>
  )
